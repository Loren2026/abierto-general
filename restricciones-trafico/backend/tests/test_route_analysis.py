...
class RouteAnalysisTests(unittest.TestCase):
    def test_asturias_madrid_detects_a6_ap6_restrictions(self):
        result = analyze_route("Oviedo", "Madrid", "2026-08-15", "2026-08-15", provider=FakeProvider(["A-66", "AP-66", "A-6", "AP-6"]))
    ...
    def test_asturias_levante_detects_a3_restrictions(self):
        result = analyze_route("Oviedo", "Valencia", "2026-08-15", "2026-08-15", provider=FakeProvider(["A-66", "A-6", "M-50", "A-3"]))
    ...
    def test_pais_vasco_detects_restrictions_and_exposes_loren_flag(self):
        result = analyze_route("Bilbao", "Donostia", "2026-08-15", "2026-08-15", provider=FakeProvider(["A-8", "AP-8", "N-240"]))
