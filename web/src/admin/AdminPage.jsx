  ...
  return (
    <AdminLayout title="Panel Loren" onLogout={handleLogout}>
      <div className="dashboard-container"><div className="dashboard-content">
        ...
        {selectedProject ? <div className="next-steps-card admin-project-detail-card"><div className="panel-header-row"><h2>{getProjectDisplayName(selectedProject)}</h2><span className="panel-header-pill">Ficha</span></div><p>{splitDescription(selectedProject.description)}</p><div className="access-meta-table"><div className="access-meta-row"><div className="access-meta-label">Creación</div><div className="access-meta-value">{formatDate(selectedProject.created_at)}</div></div><div className="access-meta-row"><div className="access-meta-label">Publicación</div><div className="access-meta-value">{formatDate(selectedProject.published_at, 'No publicado')}</div></div><div className="access-meta-row"><div className="access-meta-label">Personas con acceso</div><div className="access-meta-value">{projectAccesses.filter((a) => a.status !== 'revoked').length}</div></div></div>
